...
Route::group(['prefix' => 'posts'], function () {
    ...
    Route::get('addpost', 'Post\PostController@createPost')->name('posts#create')->middleware('auth');
    ...
    Route::get('{id}/delete', 'Post\PostController@deletePost')->name('posts#delete')->middleware('auth');
    Route::get('{id}/updatepost', 'Post\PostController@updatePost')->name('posts#update')->middleware('auth');
    ...
    Route::post('upload', 'Post\PostController@uploadPost')->name('posts#upload')->middleware('auth');
...
Route::middleware('can:isAdmin')->prefix('users')->group(function () {
    ...
    Route::get('addUser', 'User\UserController@createUser')->name('users#create')->middleware('auth');
    ...
    Route::get('{id}/delete', 'User\UserController@deleteUser')->name('users#delete')->middleware('auth');
});

Route::group(['prefix' => 'users'], function () {
    Route::get('profile', 'User\UserController@profile')->name('users#profile')->middleware('auth');
    Route::get('{id}/edit', 'User\UserController@updateUser')->name('users#edit')->middleware('auth');
    Route::post('{id}/confirmedit', 'User\UserController@confirmUpdate')->name('users#confirmUpdate')->middleware('auth');
